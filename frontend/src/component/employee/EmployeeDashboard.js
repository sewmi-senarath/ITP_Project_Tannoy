...
//     // Pass the employee ID in the URL
...
//       employee.email.toLowerCase().includes(query) || employee.contactNumber.toLowerCase().includes(query)
//     );
...
//   value={searchQuery}
//   onChange={(e) => setSearchQuery(e.target.value)} // This should correctly update the searchQuery state
// />
...
//   // Search function to filter employees by email or contact number
//   const handleSearch = () => {
//     console.log('Search button clicked'); // Check if search is triggered
...
//       employee.email.toLowerCase().includes(query) || employee.contactNumber.toLowerCase().includes(query)
//     );
//     console.log('Filtered Employees:', filtered); // Check the filtered results
//     setFilteredEmployees(filtered); // Update filtered employees state
//   };
...
const EmployeeDashboard = () => {
  ...
  }, [searchQuery, employees]); // Trigger filtering when searchQuery or employees change
